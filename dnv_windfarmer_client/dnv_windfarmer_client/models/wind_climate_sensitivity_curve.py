...
class WindClimateSensitivityCurve(BaseModel):
    """
    A class for holding a wind climate sensitivity curve.
    """ # noqa: E501
    wind_climate_id: Optional[StrictStr] = Field(default=None, description="Gets or sets the wind climate ID.", alias="windClimateId")
    entries: Optional[List[SensitivityCurveEntry]] = Field(default=None, description="Gets or sets the Entries")
    __properties: ClassVar[List[str]] = ["windClimateId", "entries"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if wind_climate_id (nullable) is None
        # and model_fields_set contains the field
        if self.wind_climate_id is None and "wind_climate_id" in self.model_fields_set:
            _dict['windClimateId'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "windClimateId": obj.get("windClimateId"),
