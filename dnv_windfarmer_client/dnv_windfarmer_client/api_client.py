...
from dnv_windfarmer_client.configuration import Configuration
from dnv_windfarmer_client.api_response import ApiResponse, T as ApiResponseT
import dnv_windfarmer_client.models
from dnv_windfarmer_client import rest
from dnv_windfarmer_client.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(dnv_windfarmer_client.models, klass)
